<?php
  ...
  {
    //this section is to delete user from the database
    if(@$_GET['demail'] && $_SESSION['key']=='admin') 
    {
      $demail=@$_GET['demail'];
      $r1 = mysqli_query($con,"DELETE FROM rank WHERE email='$demail' ") or die('Error');
      $r2 = mysqli_query($con,"DELETE FROM history WHERE email='$demail' ") or die('Error');
      $result = mysqli_query($con,"DELETE FROM signin WHERE email='$demail' ") or die('Error');
      header("location:dashboard.php?q=1");
    }
  }

  /*this part is to remove the quiz from the database*/
  if(isset($_SESSION['key']))
  {
  ...
  /*this part is for adding quiz to database*/
if(isset($_SESSION['key']))
  {
...
/*this section is adding questions to database*/
