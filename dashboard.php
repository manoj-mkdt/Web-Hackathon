...
<head>
    ...
    <title>Dashboard | GITAM Quiz System</title>
    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="margin-left: 160px; href="Javascript:void(0)"><b>GITAM Quiz System</b></a>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php 
                    if(@$_GET['q']==1) 
                    {
                        $result = mysqli_query($con,"SELECT * FROM signin") or die('Error');
                        ...
                        while($row = mysqli_fetch_array($result)) 
                        {
                            ...
                            echo '<tr><td><center>'.$c++.'</center></td>
                                      ...
                                      <td><center>'.$email.'</center></td><td>
                                      <center><a title="Delete User" href="update.php?demail='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></center></td>
                                  </tr>';
                        }
                        $c=0;
                        echo '</table></div></div>';
                ...
                <?php
                    ...
                    {
                        echo '<div class="row">
                                <span class="title1" style="margin-left:40%;font-size:30px;color:#fff;"><b>Enter Quiz Details</b></span><br /><br />
                ...
                <?php 
                    if(@$_GET['q']==5) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            $sahi = $row['sahi'];
                            $eid = $row['eid'];
                            echo '<tr>  <td><center>'.$c++.'</center></td><td><center>'.$title.'</center></td>
                                        <td><center>'.$total.'</center></td><td><center>'.$sahi*$total.'</center></td>
                                        <td><center><b>
                                                <a href="update.php?q=rmquiz&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:red;color:black"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span>
                                                </a>
                                            </b></center></td>
                                  </tr>';
                        }
