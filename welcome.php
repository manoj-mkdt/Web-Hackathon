...
<head>
    ...
    <title>Welcome | GIATM Quiz System</title>
  ...
  <div id="topbar" class="hoc clear"> 
   <div class="fl_left">
    ...
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#" style="margin-left: 160px;"><b>Gitam Quiz System</b></a>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==1) 
                {
                    $result = mysqli_query($con,"SELECT * FROM user ORDER BY date DESC") or die('Error');
                    echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
                    <tr><td><center><b>Name</b></center></td><td><center><b>email</b></center></td><td><center><b>password</b></center></td></tr>';
                    $c=1;
